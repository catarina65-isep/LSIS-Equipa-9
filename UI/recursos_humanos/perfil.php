...
if (!isset($_SESSION['utilizador_id'])) {
    echo "Erro: utilizador_id não está definido na sessão";
    exit;
}

// Verifica se o perfil está definido na sessão
if (!isset($_SESSION['id_perfilacesso'])) {
    echo "Erro: id_perfilacesso não está definido na sessão";
    exit;
}

// Permite acesso a Administrador (1), RH (2) e Colaborador (4)
$perfil = $_SESSION['id_perfilacesso'];
if (!in_array($perfil, [1, 2, 4])) {
    echo "Erro: Acesso não autorizado. Seu perfil é: " . $perfil . " (" . ($_SESSION['perfil_nome'] ?? 'Desconhecido') . ")";
    exit;
}
...
<head>
    ...
    <style>
        ...
        /* Garantir que o container principal ocupe a largura correta */
        .container-fluid {
            max-width: 100%;
            padding-right: 15px;
            padding-left: 15px;
...
<body>
    ...
    <div class="main-content">
        ...
        <main class="main-content">
            <!-- Page Header -->
            <div class="d-flex justify-content-between align-items-center mb-3 p-2 bg-white">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card border-0 shadow-sm mb-4" id="perfil">
                            <div class="card-header bg-white">
                                <h5 class="mb-0">Os Meus Dados</h5>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="modal-content">
                                ...
                                <form id="voucherForm">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="numeroCliente" class="form-label">Nº Cliente</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class='bx bx-paper-plane'></i> Pedir Voucher
                                        </button>
                                    </div>
                                </form>
                            </div>
